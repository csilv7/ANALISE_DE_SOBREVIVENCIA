...
```{r message=FALSE, warning=FALSE}
#| fig-cap: "Função de Sobrevivência segundo uma Distribuição Exponencial para diferentes valores do parâmetro de taxa."
#| label: fig-SobrExp
...
```{r message=FALSE, warning=FALSE}
#| fig-cap: "Função de Risco segundo uma Distribuição Exponencial para diferentes valores do parâmetro de taxa."
#| label: fig-RiscExp
#| fig-cap-location: top
...
plot_func <- function(data, y_var, y_label, color_values, y_expression) {
  ggplot(data, aes(x = tempo, y = !!sym(y_var), color = gamma)) +
    geom_line(stat = "summary", fun = mean, size = 1) +
    labs(x = "Tempo", y = y_expression, 
         caption = "Font: Elaborado pelo autor.", color = expression(gamma)) +
    scale_color_manual(values = color_values,
...
```{r message=FALSE, warning=FALSE}
#| fig-cap: "Função de Sobrevivência segundo uma Distribuição Weibull para diferentes valores do parâmetro de forma."
#| label: fig-SobrWei
#| fig-cap-location: top
...
```{r message=FALSE, warning=FALSE}
#| fig-cap: "Função de Risco segundo uma Distribuição Weibull para diferentes valores do parâmetro de forma."
#| label: fig-RiscWei
#| fig-cap-location: top
...
```{r message=FALSE, warning=FALSE}
#| fig-cap: "Função de Risco Acumulado segundo uma Distribuição Weibull para diferentes valores do parâmetro de forma."
...
```{r message=FALSE, warning=FALSE}
#| fig-cap: "Função de Sobrevivência segundo uma Distribuição Log-Normal para diferentes valores do parâmetro de locação."
...
```{r message=FALSE, warning=FALSE}
#| fig-cap: "Função de Risco segundo uma Distribuição Log-Normal para diferentes valores do parâmetro de locação."
...
```{r message=FALSE, warning=FALSE}
#| fig-cap: "Função de Risco Acumulado segundo uma Distribuição Log-Normal para diferentes valores do parâmetro de locação."
